                      ...
                      <center>
                          <div className="col-md-4 ">
                              <div className="body p-5 ">
                                    <Link to="/"></Link>
                                  <p className='mt-3'><b>Create your Account</b></p>
                                  {/* Email address */}
                                  ...
                                  <span>{error}</span>
                                  <Link to="/adminlogin">  <button onClick={formPost} className='btn1 mt-4'>Create account</button></Link>
                                  <p className='mt-3'>Already have an account?</p>
                                  <button className='btn2 mt-2'>Sign in</button>
